function WaveBullet(player, angle, power, speed, direction, x, y, side,trackIndex)
{
    Bullet.call(this, "img/bullet2.png", player, angle, power, {x:0, y:0}, x, y, 10, 10,trackIndex);
    this.side = side ? 1 : -1;
    this.originalX = x;
    this.originalY = y;
