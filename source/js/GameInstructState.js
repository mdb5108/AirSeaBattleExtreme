    ...
    object.Update = function(gameTime)
    {
        if(InputManager.getFire(0) || InputManager.getFire(1))
        {
            if(!this.firedOnce)
            {
                ...
                this.scoreGuid = new GameObject("img/key guide.png", GameManager.CANVAS_WIDTH/2, GameManager.CANVAS_HEIGHT/2, GameManager.CANVAS_WIDTH,GameManager.CANVAS_HEIGHT);
...
GameInstructState.prototype.Enter = function()
{
    ...
    this.instructions = new GameObject("img/control guide.png", GameManager.CANVAS_WIDTH/2, GameManager.CANVAS_HEIGHT/2, GameManager.CANVAS_WIDTH,GameManager.CANVAS_HEIGHT);
